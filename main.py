...
from routers import jogador_router, time_router, arquivos_router, escalacao_router, jogador_x_escalacao_router, evento_router, trofeu_router, jogador_x_trofeu_router
